            ...
            <Col xs={24} md={8}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: 'Vui lòng nhập số lượng văn thư được lưu trữ liên quan đến công tác Đảng',
                  },
                ]}
              >
                <Input.TextArea autoSize={{ minRows: 1, maxRows: 3 }}/>
            ...
            <Col xs={24} md={8}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: 'Vui lòng nhập số lượng văn thư được lưu trữ liên quan đến công tác Công đoàn',
                  },
                ]}
              >
                <Input.TextArea autoSize={{ minRows: 1, maxRows: 3 }}/>
