        ...
        <>
          ...
          <div className={styles.noteContainer}>
            ...
            <ul className={styles.noteList}>
              ...
              <li>
                <b><i>Hệ đào tạo, Mã môn, Tên môn, Số tín chỉ, Số tiết lý thuyết, Số tiết thảo luận, Mã
                học phần tiên quyết, Ghi chú (mô tả tóm tắt).</i></b>
              </li>
              <li>
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} md={12}>
            <Form.Item
              ...
              name="tsCTMoi"
              rules={[
                { required: true, message: 'Vui lòng nhập tổng số chương trình đào tạo xây dựng mới' },
              ]}
            >
              <Input.TextArea autoSize={{ minRows: 1, maxRows: 3 }}/>
            </Form.Item>
          ...
          <Col xs={24} md={12}>
            <Form.Item
              ...
              name="tsTLChinhSua"
              rules={[
                { required: true, message: 'Vui lòng nhập tổng số tài liệu, giáo trình cần chỉnh sửa' },
              ]}
            >
              <Input.TextArea autoSize={{ minRows: 1, maxRows: 3 }}/>
            </Form.Item>
          ...
          <Col xs={24} md={12}>
            <Form.Item
              ...
              name="tsTLMoi"
              rules={[{ required: true, message: 'Vui lòng nhập tổng số tài liệu, giáo trình biên soạn mới' }]}
            >
              <Input.TextArea autoSize={{ minRows: 1, maxRows: 3 }}/>
            </Form.Item>
          </Col>
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} md={12}>
            <Form.Item
              ...
              name="slDTGV"
              rules={[
                { required: true, message: 'Vui lòng nhập số lượng giảng viên cần đào tạo, bồi dưỡng, nâng cao trình độ chuyên môn' },
              ]}
            >
              <Input.TextArea autoSize={{ minRows: 1, maxRows: 3 }}/>
            </Form.Item>
