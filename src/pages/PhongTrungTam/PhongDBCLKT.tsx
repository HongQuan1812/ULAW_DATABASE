        ...
        <>
            ...
            <Col xs={24} md={8}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: 'Vui lòng nhập số lượng cán bộ coi thi kết thúc học phần được điều phối',
                  },
                ]}
              >
                <Input type="number" />
                ...
                rules={[
                  {
                    required: true,
                    message:
                      'Vui lòng nhập số lượng cán bộ coi thi vi phạm quy chế',
                  },
                ]}
              >
                <Input type="number" />
                ...
                rules={[
                  {
                    required: true,
                    message:
                      'Vui lòng nhập số lượng sinh viên vi phạm quy chế',
                  },
                ]}
              >
                <Input type="number" />
                ...
                rules={[
                  {
                    required: true,
                    message:
                      'Vui lòng nhập số lượng giảng viên chấm thi vi phạm quy chế',
                  },
                ]}
              >
                <Input type="number" />
            ...
            <Col xs={24} md={8}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: 'Vui lòng nhập số lượng buổi tập huấn công tác coi thi kết thúc học phần',
                  },
                ]}
              >
                <Input type="number" />
          ...
          <div className={styles.noteContainer}>
            ...
            <ul className={styles.noteList}>
              ...
              <li>
                <b>(2)</b> Theo phương pháp giảng dạy tích cực, phương pháp kiểm tra, đánh giá đáp ứng yêu cầu của chuẩn đầu ra
              </li>
              <li>
