...
import { buildPayloadBCPhongDTDH } from '@/constants/payloadMapperPhongDTDH';

const PhongDTDH: React.FC = () => {
  ...
  useEffect(() => {
    const userInfo = {
      ...
      capDonVi: 'Phòng Đào tạo Đại học',
    };
      ...
      content: (
        <>
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} md={8}>
              <Form.Item
                label="Số liệu sinh viên nhập học"
                name="soLieuSvnh"
                rules={[
                  {
                    required: true,
                    message: 'Vui lòng nhập số liệu sinh viên nhập học',
                  },
                  ...numberRule,
                ]}
              >
            ...
            <Col xs={24} md={8}>
              <Form.Item
                label="Số liệu sinh viên tốt nghiệp"
                name="soLieuSvtn"
                rules={[
                  {
                    required: true,
                    message: 'Vui lòng nhập số liệu sinh viên tốt nghiệp',
                  },
                  ...numberRule,
                ]}
              >
  ...
  const onFinish = (values: any) => {
    const payload = buildPayloadBCPhongDTDH(values);
