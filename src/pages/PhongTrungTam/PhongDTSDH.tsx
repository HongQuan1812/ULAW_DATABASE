...
import { Button, Col, Form, Input, Row, Steps, Select } from 'antd';
...
const PhongDTSDH: React.FC = () => {
  ...
  useEffect(() => {
    const userInfo = {
      ...
      capDonVi: 'Phòng Đào tạo Sau đại học',
    };
            ...
            <Col xs={24} md={8}>
              ...
              >
                <Select placeholder="Chọn trình độ đào tạo">
                  ...
                  <Select.Option value="bosung">Bổ sung kiến thức</Select.Option>
                </Select>
              </Form.Item>
            </Col>
            <Col xs={24} md={8}>
  ...
  const onFinish = (values: any) => {
    const payload = buildPayloadBCPhongDTSDH(values);
