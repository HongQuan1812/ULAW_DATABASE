        ...
        <>
          ...
          <div className={styles.noteContainer}>
            ...
            <ul className={styles.noteList}>
              ...
              <li>
                <sup className={styles.sup}>(1)</sup> Bao gồm các hoạt động: tuyên truyền, phổ biến pháp luật dưới các hình
              ...
              <li>
                <sup className={styles.sup}>(2)</sup> Trong lĩnh vực cung cấp dịch vụ tư vấn và hỗ trợ pháp luật
              </li>
            </ul>
          </div>
        </>
