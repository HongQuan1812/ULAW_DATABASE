...
def insert_ToChuc(db, config_filename="organization_config.json"):
    """
...
def insert_DonVi(db, config_filename="organization_config.json"):
    """
...
def insert_GDBC(db, config_filename="common_config.json"):
    """
...
def insert_DanhMucNganh(db, config_filename="organization_config.json"):
    """
...
if __name__ == "__main__": 
    ...
    insert_ToChuc(db, org_config_filename)
    insert_DonVi(db, org_config_filename)
    insert_DanhMucNganh(db, org_config_filename)
    insert_GDBC(db, common_config_filename)
