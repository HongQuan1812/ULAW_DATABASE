...
from Helper.load_file import load_env_file, load_config_file, load_secret
...
def get_class_readable_name(table_class, config_filename="organization_config.json"):
    """
    ...
    Args:
        ...
        config_filename (str): Path to the JSON config file.
...
def find_related_tables_from_config(main_table, config_filename="organization_config.json"):
    """
    ...
    Args:
        ...
        config_filename (str): Path to JSON config file.
...
def discover_department_schemas(Base, config_filename="organization_config.json"):
    """
    ...
    try:
        for table_class in Base.registry._class_registry.values():
            ...
            readable_name = get_class_readable_name(table_class, config_filename)
            related_tables = find_related_tables_from_config(table_name, config_filename)
...
def main():
    config_filename =  "organization_config.json"
    ...
    try:
        ...
        departments = discover_department_schemas(Base, config_filename)
